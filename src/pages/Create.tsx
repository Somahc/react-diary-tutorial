                    ...
                    <div className="col-start-3 col-span-8 bg-white my-12 p-4 rounded">
                        <form action="">
                            ...
                            <div className="mb-10">
                                ...
                                <input type="text" className="border border-black w-full p-2 rounded" placeholder="5文字以内でお願いします。" />
                            </div>
                            <div className="mb-10">
                                <h3 className="text-2xl mb-2">内容を書く</h3>
                                <textarea className="border border-black w-full p-2 rounded reseize-none h-[200px]" placeholder="30文字以内でお願いします。"></textarea>
                            </div>
                            <button className="bg-blue-700 text-white py-2 px-7 rounded">Save</button>
                        </form>
                    </div>
                </div>
            </div>
